...
func (in *HelloWorldArgs) DeepCopyInto(out *HelloWorldArgs) {
        *out = *in
        out.TypeMeta = in.TypeMeta
        if in.Names != nil {
...
func (in *HelloWorldArgs) DeepCopy() *HelloWorldArgs {
	if in == nil {
		return nil
	}
	out := new(HelloWorldArgs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *HelloWorldArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
