...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*HelloWorldArgs)(nil), (*config.HelloWorldArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
                return Convert_v1beta1_HelloWorldArgs_To_config_HelloWorldArgs(a.(*HelloWorldArgs), b.(*config.HelloWorldArgs), scope)
        }); err != nil {
                return err
        }
        if err := s.AddGeneratedConversionFunc((*config.HelloWorldArgs)(nil), (*HelloWorldArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
                return Convert_config_HelloWorldArgs_To_v1beta1_HelloWorldArgs(a.(*config.HelloWorldArgs), b.(*HelloWorldArgs), scope)
        }); err != nil {
                return err
        }
	return nil
...
//HelloWorld
func autoConvert_v1beta1_HelloWorldArgs_To_config_HelloWorldArgs(in *HelloWorldArgs, out *config.HelloWorldArgs, s conversion.Scope) error {
	if err := v1.Convert_Pointer_string_To_string(&in.Names, &out.Names, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1beta1_HelloWorldArgs_To_config_HelloWorldArgs is an autogenerated conversion function.
func Convert_v1beta1_HelloWorldArgs_To_config_HelloWorldArgs(in *HelloWorldArgs, out *config.HelloWorldArgs, s conversion.Scope) error {
	return autoConvert_v1beta1_HelloWorldArgs_To_config_HelloWorldArgs(in, out, s)
}

func autoConvert_config_HelloWorldArgs_To_v1beta1_HelloWorldArgs(in *config.HelloWorldArgs, out *HelloWorldArgs, s conversion.Scope) error {
	if err := v1.Convert_string_To_Pointer_string(&in.Names, &out.Names, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_HelloWorldArgs_To_v1beta1_HelloWorldArgs is an autogenerated conversion function.
func Convert_config_HelloWorldArgs_To_v1beta1_HelloWorldArgs(in *config.HelloWorldArgs, out *HelloWorldArgs, s conversion.Scope) error {
	return autoConvert_config_HelloWorldArgs_To_v1beta1_HelloWorldArgs(in, out, s)
}
