...
func RegisterDefaults(scheme *runtime.Scheme) error {
	...
	scheme.AddTypeDefaultingFunc(&HelloWorldArgs{}, func(obj interface{}) {
                SetObjectDefaultsHelloWorldArgs(obj.(*HelloWorldArgs))
        })
	return nil
}
...
func SetObjectDefaultsHelloWorldArgs(in *HelloWorldArgs) {
        SetDefaultHelloWorldArgs(in)
}
